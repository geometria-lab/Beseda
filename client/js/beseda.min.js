...
BesedaPackage.transport.LongPolling.isAvailable=function(a){return document.location.hostname===a.host&&(document.location.port||80)==a.port};BesedaPackage.transport.LongPolling.prototype.__initClosuredHandlers=function(){var a=this;this.__handleOpenClosure=function(b){a._handleOpen(b)};this.__handleDataClosure=function(b){a._handleData(b)};this.__handleCloseClosure=function(b){a._handleError(b)}};
...
BesedaPackage.transport.request.XHRRequest.prototype.send=function(a){if(a)this.url=a;var a=this.url+"/"+(new Date).getTime(),b=+"\u000b1"?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP"),c=this;b.onreadystatechange=function(){c.__requestStateHandler(b)};this.method==="GET"&&this.data&&(a+=(a.indexOf("?")===-1?"?":"&")+this.data);b.open(this.method,encodeURI(a),!0);a=null;if(this.method!=="GET")a=this.data,b.setRequestHeader("Content-Type","application/x-www-form-urlencoded");b.send(a)};
BesedaPackage.transport.request.XHRRequest.prototype.__requestStateHandler=function(a){a.readyState===4&&(a.status===200?this.emit("ready",a.responseText):this.emit("error"),a.abort())};BesedaPackage.transport.request.JSONPRequest=function(){BesedaPackage.events.EventEmitter.prototype.constructor.call(this);this.url=null;this.data="";this.__id=++BesedaPackage.transport.request.JSONPRequest.__lastID;this.__requestIndex=0};BesedaPackage.utils.inherits(BesedaPackage.transport.request.JSONPRequest,BesedaPackage.events.EventEmitter);
