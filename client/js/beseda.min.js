...
BesedaPackage.Transport=function(){this._emitter=this._connectionID=this._typeSuffix=this._url=null;this._isConnected=!1;this._typeSuffix=null;this.__sendQueue=[];this.__pendingMessages={}};BesedaPackage.Transport.__transports={longPolling:"LongPolling",JSONPLongPolling:"JSONPLongPolling",webSocket:"WebSocket"};
BesedaPackage.Transport.getBestTransport=function(a){for(var b,c=0;c<a.transports.length;c++){switch(a.transports[c]){case "longPolling":b=BesedaPackage.transport.LongPolling;break;case "JSONPLongPolling":b=BesedaPackage.transport.JSONPLongPolling;break;case "webSocket":b=BesedaPackage.transport.WebSocket;break;default:throw Error("Ivalid transport "+a.transports[c]);}if(b.isAvailable(a))break}return new b};
...
BesedaPackage.transport.LongPolling=function(){BesedaPackage.Transport.prototype.constructor.call(this);this._typeSuffix="longPolling";this.__handleCloseClosure=this.__handleDataClosure=this.__handleOpenClosure=this._closeRequest=this._sendRequest=this._dataRequest=this._openRequest=this._url=null;this.__initClosuredHandlers();this._initRequests();this._initListeners()};BesedaPackage.utils.inherits(BesedaPackage.transport.LongPolling,BesedaPackage.Transport);
BesedaPackage.transport.LongPolling.isAvailable=function(){return!!+"\u000b1"||window.XDomainRequest};BesedaPackage.transport.LongPolling.prototype.__initClosuredHandlers=function(){var a=this;this.__handleOpenClosure=function(b){a._handleOpen(b)};this.__handleDataClosure=function(b){a._handleData(b)};this.__handleCloseClosure=function(b){a._handleError(b)}};
BesedaPackage.transport.LongPolling.prototype._initRequests=function(){this._openRequest=new BesedaPackage.transport.request.XHRRequest("GET");this._dataRequest=new BesedaPackage.transport.request.XHRRequest("GET");this._sendRequest=new BesedaPackage.transport.request.XHRRequest("PUT");this._closeRequest=new BesedaPackage.transport.request.XHRRequest("DELETE")};
...
BesedaPackage.transport.WebSocket=function(){BesedaPackage.Transport.prototype.constructor.call(this);this._typeSuffix="webSocket";this.__handleCloseClosure=this.__handleDataClosure=this.__handleOpenClosure=this.__ws=null;this.__initClosuredHandlers()};BesedaPackage.utils.inherits(BesedaPackage.transport.WebSocket,BesedaPackage.Transport);BesedaPackage.transport.WebSocket.isAvailable=function(){return!!window.WebSocket||!!window.MozWebSocket};
...
BesedaPackage.transport.WebSocket.prototype.connect=function(a,b,c){if(!this._isConnected)this.__ws=new (window.WebSocket||window.MozWebSocket)("ws"+(c?"s":"")+"://"+a+(b?":"+b:"")+"/beseda/io/"+this._typeSuffix+"/"+(new Date).getTime()),this.__ws.addEventListener("open",this.__handleOpenClosure,!1),this.__ws.addEventListener("message",this.__handleDataClosure,!1),this.__ws.addEventListener("error",this.__handleCloseClosure,!1),this.__ws.addEventListener("close",this.__handleCloseClosure,!1)};
BesedaPackage.transport.WebSocket.prototype.disconnect=function(){this.__ws.close();this._isConnected=!1};BesedaPackage.transport.WebSocket.prototype._doSend=function(a){this.__ws.send(a)};BesedaPackage.transport.WebSocket.prototype.__handleOpen=function(){this._isConnected=!0};
...
BesedaPackage.transport.request.XHRRequest=function(a){BesedaPackage.events.EventEmitter.prototype.constructor.call(this);this.url=null;this.method=a;this.data=null};BesedaPackage.utils.inherits(BesedaPackage.transport.request.XHRRequest,BesedaPackage.events.EventEmitter);
BesedaPackage.transport.request.XHRRequest.prototype.send=function(a){debugger;if(a)this.url=a;var a=this.url+"/"+(new Date).getTime(),b=this.__createRequest(),c=this;b.onreadystatechange=function(){c.__requestStateHandler(b)};this.method==="GET"&&this.data&&(a+=(a.indexOf("?")===-1?"?":"&")+this.data);b.open(this.method,encodeURI(a),!0);a=null;if(this.method!=="GET")a=this.data,b.setRequestHeader("Content-Type","application/x-www-form-urlencoded");b.send(a)};
BesedaPackage.transport.request.XHRRequest.prototype.__requestStateHandler=function(a){a.readyState===4&&(a.status===200?this.emit("ready",a.responseText):this.emit("error"),a.abort())};BesedaPackage.transport.request.XHRRequest.prototype.__createRequest=function(){var a=null;+"\u000b1"?a=new XMLHttpRequest:window.XDomainRequest?(a=new XDomainRequest,a.onprocess=function(){}):a=new ActiveXObject("Microsoft.XMLHTTP");return a};
BesedaPackage.transport.request.JSONPRequest=function(){BesedaPackage.events.EventEmitter.prototype.constructor.call(this);this.url=null;this.data="";this.__id=++BesedaPackage.transport.request.JSONPRequest.__lastID;this.__requestIndex=0};BesedaPackage.utils.inherits(BesedaPackage.transport.request.JSONPRequest,BesedaPackage.events.EventEmitter);BesedaPackage.transport.request.JSONPRequest.__callbacks={};BesedaPackage.transport.request.JSONPRequest.__lastID=0;
BesedaPackage.transport.request.JSONPRequest.ERROR_TIMEOUT=15E3;
BesedaPackage.transport.request.JSONPRequest.prototype.send=function(a){if(a)this.url=a;var b=document.createElement("script");b.id="request_"+this.__id+"_"+this.__requestIndex;a=this.url+"/"+(new Date).getTime()+'?callback=BesedaPackage.transport.request.JSONPRequest.__callbacks["'+b.id+'"]&messages='+this.data;b.src=a;var c=this,d=setTimeout(function(){clearTimeout(d);document.body.removeChild(b);delete BesedaPackage.transport.request.JSONPRequest.__callbacks[b.id];c.emit("error")},BesedaPackage.transport.request.JSONPRequest.ERROR_TIMEOUT);
BesedaPackage.transport.request.JSONPRequest.__callbacks[b.id]=function(a){clearTimeout(d);document.body.removeChild(b);delete BesedaPackage.transport.request.JSONPRequest.__callbacks[b.id];c.emit("ready",a)};document.body.appendChild(b);this.__requestIndex++;this.data=null};
