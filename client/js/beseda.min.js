...
beseda.IO.prototype.connect=function(a,b,c){if(a!==void 0)this.__options.host=a;if(b!==void 0)this.__options.port=b;if(c!==void 0)this.__options.ssl=c;this.__transport.connect(this.__options.host,this.__options.port,this.__options.ssl)};beseda.IO.prototype.send=function(a){this.__transport.send([].concat(a))};beseda.IO.prototype.disconnect=function(){this.__transport.disconnect()};
beseda.Transport=function(){this._emitter=this._connectionID=this._typeSuffix=this._url=null;this._isConnected=!1;this._typeSuffix=null;this.__sendQueue=[];this.__pendingMessages={}};beseda.Transport.__transports={longPolling:"LongPolling",JSONPLongPolling:"JSONPLongPolling",webSocket:"WebSocket"};
beseda.Transport.getBestTransport=function(a){for(var b,c=0;c<a.transports.length;c++){switch(a.transports[c]){case "longPolling":b=beseda.transport.LongPolling;break;case "JSONPLongPolling":b=beseda.transport.JSONPLongPolling;break;case "webSocket":b=beseda.transport.WebSocket;break;default:throw Error("Ivalid transport "+a.transports[c]);}if(b.isAvailable(a))break}return new b};beseda.Transport.prototype.connect=function(){throw Error("Abstract method calling.");};
beseda.Transport.prototype.send=function(a){if(this._isConnected){for(var b=a.length-1;b>=0;)this.__pendingMessages[a[b].id]=!0,b--;this._doSend(JSON.stringify(a))}else this._enqueue(a)};beseda.Transport.prototype._doSend=function(){throw Error("Abstract method calling.");};beseda.Transport.prototype.disconnect=function(){throw Error("Abstract method calling.");};beseda.Transport.prototype.setEmitter=function(a){this._emitter=a};
beseda.Transport.prototype._handleConnection=function(a){this._connectionID=a;for(this._emitter&&this._emitter.emit("connect",this._connectionID);this.__sendQueue.length;)this.send(this.__sendQueue.shift())};beseda.Transport.prototype._handleMessages=function(a){for(var b;a&&a.length;)b=a.shift(),this._emitter.emit("message",b),delete this.__pendingMessages[b.id]};
