...
l.a.prototype.O=function(a){if(a)for(;a.length;)this.t.e("message",a.shift())};l.a.c=function(){l.a.c.h.constructor.call(this);this.H="longPolling";this.G=this.j=this.o=this.B=b;this.X=this.Z="";this.Y();var a=this;this.F=function(c){a.N(c)};this.ca=function(c){a.O(c)};this.W=function(){a.t.e("error")};this.da=function(){a.j.d.error=[]};this.B.p("ready",this.F);this.B.p("error",this.W);this.o.p("ready",this.ca);this.o.p("error",this.W);this.j.p("ready",this.da)};l.q.w(l.a.c,l.a);
