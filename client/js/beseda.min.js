...
beseda.transport.request.XHRRequest.prototype.__requestStateHandler=function(a){if(a.readyState===4)a.status===200?this.emit("ready",a.responseText):this.emit("error"),a.onreadystatechange=null,a.abort()};beseda.transport.request.JSONPRequest=function(){beseda.events.EventEmitter.prototype.constructor.call(this);this.url=null;this.data="";this.__id=++beseda.transport.request.JSONPRequest.__lastID;this.__requestIndex=0};beseda.utils.inherits(beseda.transport.request.JSONPRequest,beseda.events.EventEmitter);
