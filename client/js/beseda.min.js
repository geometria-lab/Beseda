...
c.l.send(a);c.J=b;c.log("Beseda send connection request",a)}}l.k=function(){this.d={};this.ga=10};l.k.prototype.q=function(a,c){this.d[a]||(this.d[a]=[]);this.d[a].push(c);this.d[a].length>this.ga&&this.log("Warning: possible EventEmitter memory leak detected. "+this.d[a].length+" listeners added. Use emitter.setMaxListeners() to increase limit")};l.k.prototype.S=l.k.prototype.q;
...
l.r={oa:function(a){return this.R({},a)},R:function(a,c){for(var d in c)try{a[d]=c[d].constructor==Object?this.R(a[d],c[d]):c[d]}catch(f){a[d]=c[d]}return a},w:function(a,c){function d(){}d.prototype=c.prototype;a.prototype=new d;a.prototype.constructor=a;a.h=a.prototype.h=c.prototype;d=b}};l.r.w(l,l.k);
l.prototype.v=function(a,c){if(this.C==l.u.aa)return!1;this.C=l.u.CONNECTING;this.J=c;this.l.d.connect&&this.l.d.connect.indexOf(this.F)!==-1||this.l.q("connect",this.F);this.l.v();for(var d in this.V){var f=this.V[d];this.C==l.u.I||(this.C==l.u.CONNECTING?this.ha.push("/meta/subscribe",f):this.l.send(r(this,"/meta/subscribe",f)))}};l.prototype.log=function(){"console"in window&&"log"in console&&console.log.apply(console,arguments)};
function r(a,c,d){d=d||{};d.id=a.D+"_"+ ++l.fa;d.m=c;d.D=a.D;return d}l.u={I:0,CONNECTING:1,aa:2};l.fa=0;l.ba=function(a){this.g=a};l.z=function(a){l.z.h.constructor.call(this);this.K=a;this.M=l.a.ja(a);this.M.t=this};l.r.w(l.z,l.k);l.z.prototype.v=function(){this.M.v(this.K.host,this.K.port,this.K.la)};l.z.prototype.send=function(a){for(var a=[].concat(a),c=[],d=0;d<a.length;d++)c.push(a[d].id);this.M.send(h.stringify(a),c)};l.a=function(){this.t=this.A=this.H=this.Q=b;this.L=[]};
l.a.ia={longPolling:"LongPolling",JSONPLongPolling:"JSONPLongPolling"};l.a.ja=function(a){for(var c=0;c<a.T.length;c++){var d=l.a[l.a.ia[a.T[c]]];if(d){if(d.$(a))return new d}else throw Error("Ivalid transport "+a.T[c]);}};l.a.prototype.v=function(){throw Error("Abstract method calling.");};l.a.prototype.send=function(){throw Error("Abstract method calling.");};l.a.prototype.N=function(a){this.A=a;for(this.t&&this.t.e("connect",this.A);this.L.length;)this.send(this.L.shift())};
l.a.prototype.O=function(a){if(a)for(;a.length;)this.t.e("message",a.shift())};l.a.c=function(){l.a.c.h.constructor.call(this);this.H="longPolling";this.G=this.j=this.p=this.B=b;this.X=this.Z="";this.Y();var a=this;this.F=function(c){a.N(c)};this.ca=function(c){a.O(c)};this.W=function(){a.t.e("error")};this.da=function(){a.j.d.error=[]};this.B.q("ready",this.F);this.B.q("error",this.W);this.p.q("ready",this.ca);this.p.q("error",this.W);this.j.q("ready",this.da)};l.r.w(l.a.c,l.a);
l.a.c.$=function(a){return document.location.hostname===a.host};l.a.c.prototype.Y=function(){this.B=new l.a.c.n("GET");this.p=new l.a.c.n("GET");this.j=new l.a.c.n("PUT");this.G=new l.a.c.n("DELETE")};l.a.c.prototype.v=function(a,c,d){this.Q=(d?"https":"http")+"://"+a+":"+c+"/beseda/io";this.B.send(this.Q+"/"+this.H)};l.a.c.prototype.send=function(a,c){if(this.A){this.j.data=a;this.j.send();var d=this;t(this.j,function(a){for(var e=c.length-1;e>=0;)d.t.e("message:"+c[e],a),e--})}else this.L.push(a)};
l.a.c.prototype.N=function(a){if(a=this.P(a).pa)this.j.url=this.p.url=this.G.url=this.Q+"/"+this.H+"/"+a,this.j.url+=this.Z,this.G.url+=this.X,l.a.c.h.N.call(this,a),this.A&&this.p.send()};l.a.c.prototype.P=function(a){return h.parse(a)};l.a.c.prototype.O=function(a){a=this.P(a);l.a.c.h.O.call(this,a);this.A&&this.p.send()};l.a.c.n=function(a){l.a.c.n.h.constructor.call(this);this.url=b;this.method=a||"GET";this.data=b};l.r.w(l.a.c.n,l.k);
l.a.c.n.prototype.send=function(a){if(a)this.url=a;a=this.url;c!=b&&c.abort();var c=+"\u000b1"?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP"),d=this;c.onreadystatechange=function(){var a=c;if(a.readyState===4)a.status===200?d.e("ready",a.responseText):d.e("error"),a.onreadystatechange=b,a.abort()};this.method==="GET"&&this.data&&(a+=(a.indexOf("?")===-1?"?":"&")+this.data);c.open(this.method,encodeURI(a),!0);a=b;if(this.method!=="GET")a=this.data,c.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
c.send(a)};l.a.b=function(){l.a.b.h.constructor.call(this);this.H="JSONPLongPolling";this.Z="/send";this.X="/destroy"};l.r.w(l.a.b,l.a.c);l.a.b.$=function(){return!0};l.a.b.prototype.Y=function(){this.B=new l.a.b.f;this.p=new l.a.b.f;this.j=new l.a.b.f;this.G=new l.a.b.f};l.a.b.prototype.P=function(a){return a};l.a.b.f=function(){l.a.b.f.h.constructor.call(this);this.url=b;this.data="";this.o=++l.a.b.f.ea;this.i=0;this.s={};l.a.b.f.U[this.o]={}};l.r.w(l.a.b.f,l.k);l.a.b.f.U=[];l.a.b.f.ea=0;
l.a.b.f.prototype.send=function(a){if(a)this.url=a;(function(a,d,f){l.a.b.f.U[d.o][a]=function(e){clearTimeout(f);console.log("request_"+d.o+"_"+a);document.body.removeChild(document.getElementById("request_"+d.o+"_"+a));delete d.s[a];d.e("ready",e)}})(this.i,this,function(a,d){return setTimeout(function(){document.body.removeChild(document.getElementById("request_"+d.o+"_"+a));delete d.s[a];d.e("error")},15E3)}(this.i,this));a=this.url;a+=(a.indexOf("?")===-1?"?":"&")+"callback=Beseda.Transport.JSONPLongPolling.JSONPRequest.__callbacks["+
this.o+"]["+this.i+"]&"+(new Date).getTime()+"&messages="+this.data;this.s[this.i]=document.createElement("script");this.s[this.i].src=a;this.s[this.i].id="request_"+this.o+"_"+this.i;document.body.appendChild(this.s[this.i]);this.data=b;this.i++};l.a.b.ma=function(){l.a.b.f.h.constructor.call(this);this.url=b};